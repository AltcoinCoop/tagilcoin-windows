...
Makefile: bitcoin-qt.pro  ../mxe/usr/i686-w64-mingw32.static/qt/mkspecs/win32-g++-4.6/qmake.conf ../mxe/usr/i686-w64-mingw32.static/qt/mkspecs/qdevice.pri \
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) /mnt/tagilcoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) /mnt/tagilcoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
/mnt/tagilcoin/src/leveldb/libleveldb.a: FORCE
	cd /mnt/tagilcoin/src/leveldb && CC=i686-w64-mingw32.static-gcc CXX=i686-w64-mingw32.static-g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -fno-keep-inline-dllexport -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && i686-w64-mingw32.static-ranlib /mnt/tagilcoin/src/leveldb/libleveldb.a && i686-w64-mingw32.static-ranlib /mnt/tagilcoin/src/leveldb/libmemenv.a
