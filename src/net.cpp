...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TagilCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed.tagilcoin.org", "seed.tagilcoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TagilCoin is probably already running."), addrBind.ToString().c_str());
        else
