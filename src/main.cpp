...
uint256 hashGenesisBlock("0x0c8158a46f2871bed4a91c58d7375225e72107444afc25d64d18b6e646f257f7");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // TagilCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "TagilCoin Signed Message:\n";
...
{
    // TagilCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
   ...
   int64 nSubsidy = 25 * COIN;
    if(nHeight == 3)  
    {
        nSubsidy = 3000003 * COIN;
    }
    else if(nHeight == 4)  
    {
        nSubsidy = 3000004 * COIN;
    }
    ...
    nSubsidy >>= (nHeight / 840000); // TagilCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 50 * 300; // TagilCoin: 3.5 days ?
static const int64 nTargetSpacing = 1 * 60; // TagilCoin: 1 minute
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // TagilCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // TagilCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // TagilCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
       ...
       // pchMessageStart[3] = 0xdc;
        hashGenesisBlock = uint256("0x0c8158a46f2871bed4a91c58d7375225e72107444afc25d64d18b6e646f257f7");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Tagilcoin genesis block";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("409daf57c477b0d6138d4a035f921d609071ed0a1144d76301aadc521791681b9703e9cc0e9d3583d24688ba09b9bf0e2494aa1da0eabcc9839104f828fcb2da2f") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1510489170;
        ...
        assert(block.hashMerkleRoot == uint256("0x70317c34572ed0b5769e327579a6cde354c14afe4f694ae3788bf10d4f6b7d5f"));
...
unsigned char pchMessageStart[4] = { 0xcb, 0xb0, 0xd6, 0xdf }; // TagilCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TagilCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TagilCoinMiner : ProcessBlock, block not accepted");
    }
