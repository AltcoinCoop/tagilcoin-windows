TagilCoin integration/staging tree
================================
...
If it is a simple/trivial/non-controversial change, then one of the TagilCoin
...
regularly to indicate new official, stable release versions of TagilCoin.
